      ...
      {!isOpen ? (
        ...
        <div className="relative top-0 left-0 h-full bg-maroon w-72 rounded-r-xl transition-sidebar">
          <ul className="flex flex-col min-h-screen gap-2">
            ...
            <Link to="/home-admin">
              <li className={`text-white text-base flex items-center px-4 py-3 m-2 ${isActive("/home-admin") ? "bg-blue rounded-xl" : ""} hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}>
                <MdDashboard className="text-3xl mr-2" />Dashboard
              </li>
            </Link>
            ...
            <Link to="/create-accounts">
              <li className={`text-white text-base flex items-center px-4 py-3 m-2 ${isActive("/create-accounts") ? "bg-blue rounded-xl" : ""} hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}>
                <TbSettings className="text-3xl mr-2" />Create Account
              </li>
            </Link>
